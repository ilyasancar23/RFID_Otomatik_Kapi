...
byte ID[4] = {35, 22, 181, 152};          //Yetkili kart ID'sini tanımlıyoruz. 
byte ID2[4] = {211, 199, 22, 174};          //Yetkili kart ID'sini tanımlıyoruz. 
...
void loop() {
  ...
  if (rfid.uid.uidByte[0] == ID[0] &&     //Okunan kart ID'si ile ID değişkenini karşılaştırıyoruz.
    ...
    if (rfid.uid.uidByte[0] == ID2[0] &&     //Okunan kart ID'si ile ID2 değişkenini karşılaştırıyoruz.
